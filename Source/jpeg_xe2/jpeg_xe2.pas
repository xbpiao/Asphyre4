      ...
      try
        ...
        try
          ...
          begin
            ...
            SrcScanline := Pointer(Integer(PByte(SrcScanline)) + (PtrInc * LinesWritten));
          end;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                while (Integer(CurPixel) - Integer(DestScanLine)) < (AWidth * 4) do
                begin
...
{$ENDIF}
              DestScanline := PByte(Integer(PByte(DestScanline)) + (PtrInc * LinesRead));
            end;
