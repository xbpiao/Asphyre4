...
//---------------------------------------------------------------------------
uses
 Classes, SysUtils, Math, StreamEx, TrueColors, AsphyreUtils;
...
//---------------------------------------------------------------------------
 ...
 private
  ...
  function GetFirstColor(Theta: Real): PAsphyreColorNode;
  function GetColor(Theta: Real): TTrueColor;
  function GetNextColor(Theta: Real): PAsphyreColorNode;
  procedure SetTime(const Value: Real);
 public
  property Count: Integer read GetCount;
  property Items[Num: Integer]: PAsphyreColorNode read GetItem; default;
  property Color[Theta: Real]: TTrueColor read GetColor;
  property Time: Real read FTime write SetTime;
  property Name: string read FName write FName;

  function Add(Color: TTrueColor; NodeType: TNodeType; Theta: Real): Integer; overload;
  function Add(Node: TAsphyreColorNode): Integer; overload;
  function Add(Diffuse: Longword; Theta: Real): Integer; overload;
...
//---------------------------------------------------------------------------
 ...
 private
  ...
  function GetColor(Theta, Time: Real): TTrueColor;
  function GetFirstPal(Time: Real): TAsphyrePalette;
  function GetPrevPal(Time: Real): TAsphyrePalette;
  function GetSuccPal(Time: Real): TAsphyrePalette;
 public
  property Count: Integer read GetCount write SetCount;
  property Items[Num: Integer]: TAsphyrePalette read GetItem write SetItem; default;
  property Color[Theta, Time: Real]: TTrueColor read GetColor;
...
//---------------------------------------------------------------------------
function TAsphyrePalette.Add(Color: TTrueColor; NodeType: TNodeType; Theta: Real): Integer;
var
 Index: Integer;
begin
 Index:= Length(Data);
...
//---------------------------------------------------------------------------
function TAsphyrePalette.Add(Diffuse: Longword; Theta: Real): Integer;
begin
...
//--------------------------------------------------------------------------
function TAsphyrePalette.GetFirstColor(Theta: Real): PAsphyreColorNode;
var
 i, Frame, wIndex: Integer;
 Delta, NewDelta, WorstD: Real;
begin
 Delta:= High(Integer);
 Frame:= -1;
 wIndex:= -1;
...
//--------------------------------------------------------------------------
function TAsphyrePalette.GetNextColor(Theta: Real): PAsphyreColorNode;
var
 i, Frame, wIndex: Integer;
 Delta, NewDelta, wDelta: Real;
begin
 Delta:= High(Integer);
 Frame:= -1;
 wIndex:= -1;
...
//---------------------------------------------------------------------------
function TAsphyrePalette.GetColor(Theta: Real): TTrueColor;
const
 PiHalf = Pi * 0.5;
var
...
//---------------------------------------------------------------------------
procedure TAsphyrePalette.SetTime(const Value: Real);
begin
...
//--------------------------------------------------------------------------
function TAsphyrePalettes.GetFirstPal(Time: Real): TAsphyrePalette;
var
 i, LowerIndex, BestIndex: Integer;
 LowerDelta, Delta, BestDelta: Real;
begin
...
//--------------------------------------------------------------------------
function TAsphyrePalettes.GetPrevPal(Time: Real): TAsphyrePalette;
var
 i, LowerIndex, BestIndex: Integer;
 LowerDelta, Delta, BestDelta: Real;
begin
...
//--------------------------------------------------------------------------
function TAsphyrePalettes.GetSuccPal(Time: Real): TAsphyrePalette;
var
 i, HigherIndex, BestIndex: Integer;
 HigherDelta, BestDelta, Delta: Real;
begin
...
//---------------------------------------------------------------------------
function TAsphyrePalettes.GetColor(Theta, Time: Real): TTrueColor;
const
 PiHalf = Pi * 0.5;
var
