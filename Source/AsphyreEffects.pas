...
type
 {$IFDEF AsphyreUseDx8}
 TAsphyreEffectHandler = procedure(Sender: TObject; const Dev9: IDirect3DDevice8;
  var Code: Integer; var Handled: Boolean) of object;
 {$ELSE}
 TAsphyreEffectHandler = procedure(Sender: TObject; const Dev9: IDirect3DDevice9;
  var Code: Integer; var Handled: Boolean) of object;
 {$ENDIF}
...
//---------------------------------------------------------------------------
 ...
 private
  ...
  {$IFDEF AsphyreUseDx8}
  procedure DefaultEffectHandler(Sender: TObject; const Dev9: IDirect3DDevice8;
   var Code: Integer; var Handled: Boolean);
  {$ELSE}
  procedure DefaultEffectHandler(Sender: TObject; const Dev9: IDirect3DDevice9;
   var Code: Integer; var Handled: Boolean);
  {$ENDIF}
 public
  ...
  {$IFDEF AsphyreUseDx8}
  function HandleCode(Sender: TObject; const Dev9: IDirect3DDevice8;
   Code: Integer): Boolean;
  {$ELSE}
  function HandleCode(Sender: TObject; const Dev9: IDirect3DDevice9;
   Code: Integer): Boolean;
  {$ENDIF}
  constructor Create();
 end;
...
function TAsphyreEffectManager.HandleCode(Sender: TObject;
 const Dev9: IDirect3DDevice8; Code: Integer): Boolean;
var
 i: Integer;
begin
 Result:= False;
...
{$ELSE}
function TAsphyreEffectManager.HandleCode(Sender: TObject;
  const Dev9: IDirect3DDevice9; Code: Integer): Boolean;
var
 i: Integer;
begin
 Result:= False;
...
//     SetSamplerState(1, D3DSAMP_MIPFILTER, D3DTEXF_LINEAR);
 ...
 if (Code and fxfDiffuse > 0)  then
  begin
   ...
   // 指定颜色混合来源
   Dev9.SetTextureStageState(0, D3DTSS_COLORARG1, D3DTA_TEXTURE);
   Dev9.SetTextureStageState(0, D3DTSS_COLORARG2, D3DTA_DIFFUSE);
   // 指定Alpha操作来源
   Dev9.SetTextureStageState(0, D3DTSS_ALPHAARG1, D3DTA_TEXTURE);
   Dev9.SetTextureStageState(0, D3DTSS_ALPHAARG2, D3DTA_DIFFUSE);
